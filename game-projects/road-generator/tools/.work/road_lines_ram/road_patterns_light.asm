...
Road_R00008
        ...
        pshu  d,x
        rts
* uses=61  D=$1333 X=$3333
Road_R00009
        ldd   #$1333
        ldx   #$3333
        pshu  d,x
        rts
* uses=13  D=$3333 X=$3315
Road_R00010
        ldd   #$3333
        ldx   #$3315
        pshu  d,x
        rts
* uses=11  D=$5133 X=$3333
Road_R00011
        ldd   #$5133
        ldx   #$3333
        pshu  d,x
        rts
* uses=68  D=$3333 X=$3331
Road_R00012
        ldd   #$3333
        ldx   #$3331
        pshu  d,x
...
Road_R00080
        ...
        pshu  d,x
        rts
* uses=1  D=$5555 X=$5533
Road_R00081
        ldd   #$5555
        ldx   #$5533
        pshu  d,x
        rts
* uses=3  D=$3155 X=$5555
Road_R00082
        ldd   #$3155
        ldx   #$5555
        pshu  d,x
...
Road_R00083
        ...
        pshu  d,x
        rts
* uses=1  D=$5555 X=$5513
Road_R00084
        ldd   #$5555
        ldx   #$5513
        pshu  d,x
        rts
* uses=4  D=$3355 X=$5555
Road_R00085
        ldd   #$3355
        ldx   #$5555
        pshu  d,x
...
Road_R00098
        ...
        pshu  d,x
        rts
* uses=24  D=$5555 X=$5511
Road_R00099
        ldd   #$5555
        ldx   #$5511
        pshu  d,x
        rts
* uses=24  D=$1155 X=$5555
Road_R00100
        ldd   #$1155
        ldx   #$5555
        pshu  d,x
...
Road_R00102
        ...
        pshu  d,x
        rts
* uses=12  D=$1555 X=$5555
Road_R00103
        ldd   #$1555
        ldx   #$5555
        pshu  d,x
        rts
* uses=13  D=$5555 X=$5551
Road_R00104
        ldd   #$5555
        ldx   #$5551
        pshu  d,x
...
Road_R00144
        ...
        pshu  d,x
        rts
* uses=12  D=$3111 X=$5555
Road_R00145
        ldd   #$3111
        ldx   #$5555
        pshu  d,x
        rts
* uses=7  D=$3311 X=$1555
Road_R00146
        ldd   #$3311
        ldx   #$1555
        pshu  d,x
        rts
* uses=5  D=$5555 X=$1113
Road_R00147
        ldd   #$5555
        ldx   #$1113
        pshu  d,x
...
Road_R00158
        ...
        pshu  d,x
        rts
* uses=124  D=$1111 X=$3333
Road_R00159
        ldd   #$1111
        ldx   #$3333
        pshu  d,x
        rts
* uses=10  D=$5111 X=$3333
Road_R00160
        ldd   #$5111
        ldx   #$3333
        pshu  d,x
        rts
* uses=49  D=$3333 X=$3111
Road_R00161
        ldd   #$3333
        ldx   #$3111
        pshu  d,x
        rts
* uses=120  D=$3333 X=$1111
Road_R00162
        ldd   #$3333
        ldx   #$1111
        pshu  d,x
...
Road_R00193
        ...
        pshu  d,x
        rts
* uses=4  D=$5111 X=$1333
Road_R00194
        ldd   #$5111
        ldx   #$1333
        pshu  d,x
        rts
* uses=34  D=$1111 X=$1333
Road_R00195
        ldd   #$1111
        ldx   #$1333
        pshu  d,x
        rts
* uses=13  D=$5111 X=$1133
Road_R00196
        ldd   #$5111
        ldx   #$1133
        pshu  d,x
        rts
* uses=12  D=$5511 X=$1133
Road_R00197
        ldd   #$5511
        ldx   #$1133
        pshu  d,x
        rts
* uses=32  D=$3331 X=$1111
Road_R00198
        ldd   #$3331
        ldx   #$1111
        pshu  d,x
        rts
* uses=12  D=$3311 X=$1115
Road_R00199
        ldd   #$3311
        ldx   #$1115
        pshu  d,x
...
Road_R00221
        ...
        pshu  d,x
        rts
* uses=69  D=$3311 X=$1111
Road_R00222
        ldd   #$3311
        ldx   #$1111
        pshu  d,x
        rts
* uses=6  D=$5511 X=$1113
Road_R00223
        ldd   #$5511
        ldx   #$1113
        pshu  d,x
        rts
* uses=71  D=$5511 X=$1111
Road_R00224
        ldd   #$5511
        ldx   #$1111
        pshu  d,x
        rts
* uses=6  D=$3111 X=$1115
Road_R00225
        ldd   #$3111
        ldx   #$1115
        pshu  d,x
        rts
* uses=2  D=$5111 X=$1113
Road_R00226
        ldd   #$5111
        ldx   #$1113
        pshu  d,x
        rts
* uses=2  D=$3111 X=$1155
Road_R00227
        ldd   #$3111
        ldx   #$1155
        pshu  d,x
...
Road_R00245
        ...
        pshu  d,x
        rts
* uses=87  D=$1111 X=$1111
Road_R00246
        ldd   #$1111
        ldx   #$1111
        pshu  d,x
        rts
* uses=20  D=$5111 X=$1111
Road_R00247
        ldd   #$5111
        ldx   #$1111
        pshu  d,x
        rts
* uses=16  D=$3111 X=$1111
Road_R00248
        ldd   #$3111
        ldx   #$1111
        pshu  d,x
        rts
* uses=20  D=$1111 X=$1115
Road_R00249
        ldd   #$1111
        ldx   #$1115
        pshu  d,x
...
* ─── 66 variants Road_draw_KX_JY (light) ───
*   herbe : D=$3333 X=$3333
