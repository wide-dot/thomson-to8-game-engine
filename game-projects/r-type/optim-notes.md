...
>>>>>>> 341a405ab1b4c61eab0775fae8968028badeb497
```
...
Note les options de l'étape 3 sont un peu longue. Cependant si on lance juste avec l'option `-prev-args`, alors l'outil ira retrouver les arguments de la ligne de commande dans le fichier CSV accompagnant le HTML.
