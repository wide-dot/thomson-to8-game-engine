package fr.bento8.to8.audio.YMTool.ym;

import java.io.IOException;
import java.util.Arrays;
import fr.bento8.to8.audio.YMTool.vgm.VGMInterpreter;
import fr.bento8.to8.audio.YMTool.vgm.VGMListener;

public class YMTools {
  public static int[] getYMdata(VGMInterpreter paramVGMInterpreter, int paramInt) throws IOException {
    ...
    paramVGMInterpreter.addVGMPortListener(new VGMListener() {
          public void writeYMport(int param1Int) {
            if ((param1Int & 0x80) != 0) {
  ...
  public static int[] compressYM(int[] paramArrayOfint) {
