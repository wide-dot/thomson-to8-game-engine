...
@hookroutine  equ   *-1
        sta   routine,u
        sta   hooked_status,u
        _soundFX.play soundFX.PodAttachSound,3
        ldb   status_flags,u
...
@level1
        ...
        _ldd  ObjID_forcepod_simplefire,3   ; fire HORIZONTAL
...
@level3
        ...
        jsr   LoadObject_x
        beq   >                             ; branch if no more available object slot
        _ldd  ObjID_forcepod_simplefire,1   ; fire UP
        std   id,x                          ; and subtype
        jsr   LoadObject_x
        beq   >                             ; branch if no more available object slot
        _ldd  ObjID_forcepod_simplefire,5   ; fire DOWN
        std   id,x                          ; and subtype
@level2
        jsr   LoadObject_x
        beq   >                             ; branch if no more available object slot
        _ldd  ObjID_forcepod_simplefire,2   ; fire DIAGONAL UP
        std   id,x                          ; and subtype
        jsr   LoadObject_x
        beq   >                             ; branch if no more available object slot
        _ldd  ObjID_forcepod_simplefire,4   ; fire DIAGONAL DOWN
        std   id,x                          ; and subtype
!
        rts
