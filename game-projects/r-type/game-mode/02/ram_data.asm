...
* Object Constants
* ===========================================================================
nb_dynamic_objects           equ 45 ; -3 for the static weapon slots below (total object RAM kept ~constant)
nb_graphical_objects         equ 48 ; max 64 total (45 dynamic + 3 static weapon slots)
...
; routine starts at 0 (id only); set to their Dormant routine at Level02_Start so they
